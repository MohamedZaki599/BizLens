...
export const onboardingAr: Record<string, string> = {
  ...
  'activation.milestone.signal_reviewed.hint': 'أقر أو تحقق من إشارة تشغيلية',
  'activation.milestone.first_action': 'اتخذ أول إجراء',
  'activation.milestone.first_action.hint': 'نفّذ توصية من بيزلنز',

  // ─── Empty States ───────────────────────────────────────────────────────
  'empty.no-data.title': 'قصتك تبدأ هنا',
  'empty.no-data.desc': 'أضف أول معاملة وسيبدأ بيزلنز في رسم خريطة مشهدك المالي تلقائيًا.',
  ...
  'empty.assistant-idle.title': 'مساعدك جاهز',
  'empty.assistant-idle.desc': 'اسأل سؤالًا عن ماليّاتك أو استكشف إشارة للحصول على إرشاد سياقي.',
